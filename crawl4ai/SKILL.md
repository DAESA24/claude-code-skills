...
**This skill uses the web-crawling PBC for execution.**

Before running any crawl4ai code, read the PBC instructions:

1. `C:\Users\drewa\pbcs\pbc-web-crawling\CLAUDE.md` - PBC overview
2. `C:\Users\drewa\pbcs\pbc-web-crawling\tool-crawl4ai\CLAUDE.md` - Detailed setup and venv path

**Quick reference:** Use this Python interpreter for all crawl4ai operations:
