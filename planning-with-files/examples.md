...
**Deliverable: The code changes themselves**

For dev work, the deliverable is typically the modified codebase - commits, PRs, or the working feature.
...
## Example 5: Full Workflow with Directory Structure and Frontmatter
...
## Status
**Currently in Phase 2** - Researching sources
```
...
### Source 1: Harvard Health
- URL: https://health.harvard.edu/...
- Key points:
  - Cortisol levels peak in morning, exercise capitalizes on this
  - Improved focus for 4-6 hours post-exercise

### Source 2: Sleep Foundation
- URL: https://sleepfoundation.org/...
- Key points:
  - Morning exercisers have better sleep quality
...
Where the deliverable goes depends on the workspace:
- **Knowledge vault:** Might go to an inbox or specific folder
- **Dev project:** Might be a code change, commit, or documentation file
- **Check workspace CLAUDE.md** for guidance
...
Morning exercise offers both physical and mental benefits...

[Full content here]
```

### Step 5: Finalize task_plan.md Frontmatter

Update the frontmatter to reflect completion:
...
phases_completed: 4
deliverables:
  - "morning-exercise-benefits-summary.md"
---
```
